...
//create_clock -name serial_clk -period 2.694 -waveform {0 1.347} [get_nets {serial_clk}] -add
//create_clock -name pix_clk -period 13.468 -waveform {0 6.734} [get_nets {pix_clk}] -add
create_clock -name PIXCLK -period 25 -waveform {0 12.5} [get_ports {PIXCLK}] -add
